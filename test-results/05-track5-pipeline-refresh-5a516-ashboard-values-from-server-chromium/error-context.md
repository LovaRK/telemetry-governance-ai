...
- Name: 05-track5-pipeline-refresh-e2e.test.ts >> Track 5: Pipeline Refresh E2E >> pipeline updates dashboard values from server
- Location: tests/e2e/05-track5-pipeline-refresh-e2e.test.ts:8:7
