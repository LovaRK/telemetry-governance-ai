...
- Name: 01-dashboard-loads-without-hardcoded-data.test.ts >> Dashboard E2E Tests >> connection screen loads without hard-coded data
- Location: tests/e2e/01-dashboard-loads-without-hardcoded-data.test.ts:4:7
...
- button "Sign In"
- paragraph: "Default: admin@demo.local / Demo@12345"
- alert
```
