-- ============================================
-- Migration 001: Core Tables & Utility Functions
-- Date: 2026-05-16
-- Description: Initialize telemetry snapshots, cache metadata, decision traces, and refresh jobs
-- ============================================
...
CREATE TABLE IF NOT EXISTS cache_metadata (
    ...
    source_type     VARCHAR(50) NOT NULL DEFAULT 'splunk',
    error_message   TEXT,
    created_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at      TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
